...
from .views import SavingsGoalAPIView, FundSavingsGoalAPIView, SavingsGoalContributeWithdrawAPIView, SpecificSavingsGoalHistoryAPIView, UserAllSavingsHistoryAPIView,SavingsDashboardAnalyticsAPIView
...
urlpatterns = [
    ...
    path('goals/<int:goal_id>/fund/', FundSavingsGoalAPIView.as_view(), name='fund-savings-goal'),
